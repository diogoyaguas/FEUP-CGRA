...
class Plane extends CGFobject
{
	constructor(scene, nrDivs) 
	{
		...
		this.materialF.setAmbient(0.1,0.1,0.1,1);
		this.materialF.setDiffuse(0.06,0.10,1.47,1);
		this.materialF.setSpecular(0.1,0.03,0.03,1);	
		this.materialF.setShininess(100);
